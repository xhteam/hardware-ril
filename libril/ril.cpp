...
*/
	...
	case RIL_REQUEST_PTT_QUERY_AVAILABLE_GROUPS: return "PTT_QUERY_AVAILABLE_GROUPS";
	case RIL_REQUEST_PTT_GROUP_SETUP: return "PTT_GROUP_SETUP";
	case RIL_REQUEST_PTT_GROUP_RELEASE: return "PTT_GROUP_RELEASE";
	case RIL_REQUEST_PTT_CALL_DIAL: return "PTT_CALL_DIAL";
	case RIL_REQUEST_PTT_CALL_HANGUP: return "PTT_CALL_HANGUP";
	case RIL_REQUEST_PTT_CURRENT_GROUP_SCANLIST_UPDATE: return "PTT_CURRENT_GROUP_SCANLIST_UPDATE";
	case RIL_REQUEST_PTT_QUERY_BLOCKED_INDICATOR: return "PTT_QUERY_BLOCKED_INDICATOR";
	case RIL_REQUEST_PTT_DEVICE_INFO: return "PTT_DEVICE_INFO";
	case RIL_REQUEST_PTT_QUERY_BIZ_STATE: return "PTT_QUERY_BIZ_STATE";
	/* end add */
	...
	/* add by ferris, Jul18, 2014*/
	case RIL_UNSOL_PTT_CALL_INDICATOR: return "UNSOL_PTT_CALL_INDICATOR";
	case RIL_UNSOL_PTT_GROUP_RELEASE: return "UNSOL_PTT_GROUP_RELEASE";
	case RIL_UNSOL_PTT_NOTIFICATION_CALL: return "UNSOL_PTT_NOTIFICATION_CALL";
	case RIL_UNSOL_PTT_CALL_CONNECT: return "UNSOL_PTT_CALL_CONNECT";
