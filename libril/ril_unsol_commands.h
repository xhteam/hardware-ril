...
*/
    ...
    {RIL_UNSOL_PTT_CALL_INDICATOR, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_GROUP_RELEASE, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_NOTIFICATION_CALL, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_CALL_CONNECT, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_CALL_HANGUP, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_OUTGOING_CALL_PROGRESS, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_BLOCKED_INDICATOR, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_AVAILABLE_GROUP_CHANGED, responseGroupList, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_NOTIFICATION_DIAL, responseStrings, WAKE_PARTIAL},
    {RIL_UNSOL_PTT_CURRENT_GROUP_ACTIVE_LIST, responseInts, WAKE_PARTIAL},
		{RIL_UNSOL_PTT_DEVICE_INFO,responseInts,WAKE_PARTIAL},
    {RIL_UNSOL_PTT_GROUP_OWNER,responseInts,WAKE_PARTIAL},
		{RIL_UNSOL_PTT_TRUNKING_MODE,responseInts,WAKE_PARTIAL},
    {RIL_UNSOL_PTT_NOTIFICATION_JOIN_GROUP,responseInts,WAKE_PARTIAL},
    {RIL_UNSOL_PTT_BIZ_INFO,responsePttBizState,WAKE_PARTIAL},
    {RIL_UNSOL_PTT_NETWORK_VERSION,responseInts,WAKE_PARTIAL},
		/* end add */
