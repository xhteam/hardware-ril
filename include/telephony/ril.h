 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_PTT_QUERY_BIZ_STATE 117

#define RIL_REQUEST_PTT_DEBUG 118
#define RIL_REQUEST_RIL_DEBUG 119
...
#define FERRIS_UNSOL_BASE RIL_UNSOL_VOICE_RADIO_TECH_CHANGED 
